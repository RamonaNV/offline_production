...
@icetray.traysegment_inherit(I3CLSimMakePhotons,
    dict(MCPESeriesName="MCPESeriesMap",PhotonSeriesName=None))
def I3CLSimMakeHits(tray, name, **kwargs):
    return I3CLSimMakePhotons(tray, name, **kwargs)