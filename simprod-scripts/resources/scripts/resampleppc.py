...
def configure_tray(tray, params, stats, logger):
    ...
    ppc.configure_tray(tray, params, stats, logger)
...
def main():
    ...
    """
    # Get Params
    parser = argparse.ArgumentParser(description="PPCResampleCorsika script")
    add_args(parser)
    ...
    # Execute Tray
    summary = RunI3Tray(params, configure_tray, "PPCResampleCorsika",
